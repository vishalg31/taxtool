export const DEDUCTIONS_CONFIG = [
  ...
  },
  {
    ...
    description:
      "Exemption on travel costs reimbursed by your employer for domestic travel during leave. Covers air, rail, or bus fare only - hotel, food, and local transport are not covered. Available for self and family (spouse, up to 2 children, dependent parents/siblings).",
    cap: null,
    capNote: "Actual travel cost only - no fixed cap. Limited to LTA in your CTC.",
    regimes: ["old"],
    group: "advanced",
    inputType: "amount",
    eligibility:
      "Old regime only. Max 2 journeys in the 2026-2029 block. Enter actual travel fare claimed - not your full LTA component. Submit tickets/boarding passes to payroll.",
    nriEligible: true,
  },
];
