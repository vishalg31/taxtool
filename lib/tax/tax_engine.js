...
const TAX_RULES = {
  ...
  old: {
    ...
    hra: {
      ...
      metroCities: ["mumbai", "delhi", "kolkata", "chennai", "bengaluru", "hyderabad", "pune", "ahmedabad"],
...
function calculateRebate87A(taxBeforeRebate, taxableIncome, regime, isNRI = false) {
  if (isNRI) return 0;
...
function calculateTax(input) {
  ...
  const rebate = calculateRebate87A(taxBeforeRebate, taxableIncome, regime, isNRI);
